...
15 Sep 2026. The PDM, the ATZ-7 and the regulator all sit in a custom box
where the old battery box was - decided 17 Sep 2026.
...
POSITIONS = {
    ...
    "RR":       (P,    200, "est",  "custom box where the old battery box was, with the PDM and battery - decided 17 Sep 2026"),
    ...
    "USB":      (400,  800, "est",  "NOT PLACED (#64) - cut for the handlebar, the longest case; trim if it lands under the seat"),
...
def main():
    ...
    w(f"**PDM breakout: {PDM_TRUNK_MM} mm from the headlight datum**, the old B06 "
      ...
      "the regulator all sit in a custom box where the old battery box was. "
      "Decided 17 Sep 2026.\n")
    ...
    if PDM_DONE:
        w(f"✅ **Done {PDM_DONE}.** All {len(pdm)} cut, labelled, sealed, crimped and seated "
          ...
          "first seated mirror-image and re-seated column-for-column, finished 18 Sep (#66). "
          "The cavities below are the corrected ones.\n")
