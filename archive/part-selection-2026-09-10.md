> **ARCHIVED 10 Sep 2026 — do not order from this file.** This is the full
> working-out behind `docs/part-selection.md`, including superseded decisions,
> corrections and dated history, kept for provenance. Some of it is contradicted
> by later decisions. Example: *"Do NOT solve this by moving 18 AWG to 16 AWG"*,
> written 3 Sep, which the 4 Sep all-16 AWG decision then did. The current state
> is `docs/part-selection.md`, and the model is authoritative over both.
