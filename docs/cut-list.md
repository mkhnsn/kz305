...
**PDM breakout: 835 mm from the headlight datum**, the old B06 fan-out beside the battery. Decided 15 Sep 2026. The PDM, the battery and the regulator all sit in the old battery box. Decided 17 Sep 2026.
...
| c9 r2 (F10 OUT) | `W_USB_FEED` | BG | 16 AWG | USB | 300 | **800** | est |
...
| `W_ALT` | YE/YE | 14 AWG | RR | ALT | 625 | **1150** | est |
...
| `W_USB_GND` | BK | 16 AWG | SP_GND | USB | 300 | **800** | est |
...
|---|---|---|---|---|
| 12 AWG | BK | 1.6 m | 10 ft (3.0 m) | 1.4 m |
