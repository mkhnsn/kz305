...
| `W_GND_HEAD` | HEAD | GND_NETB | BKYE | 18 AWG |
| `W_GND_IND_L` | IND_L | SP_POD_GND | BKYE | 18 AWG |
| `W_GND_IND_R` | IND_R | SP_POD_GND | BKYE | 18 AWG |
| `W_GND_SIG_FL` | SIG_FL | GND_NETB | BKYE | 18 AWG |
| `W_GND_SIG_FR` | SIG_FR | GND_NETB | BKYE | 18 AWG |
| `W_GND_SIG_RL` | SIG_RL | GND_NETB | BKYE | 18 AWG |
| `W_GND_SIG_RR` | SIG_RR | GND_NETB | BKYE | 18 AWG |
| `W_GND_SPD` | LAMP_SPD | GND_NETB | BKYE | 18 AWG |
| `W_GND_TAC` | LAMP_TAC | GND_NETB | BKYE | 18 AWG |
| `W_GND_TAIL` | TAIL | GND_NETB | BKYE | 18 AWG |
